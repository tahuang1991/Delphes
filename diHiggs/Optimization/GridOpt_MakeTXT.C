...
void GridOpt_MakeTXT( TString folder = "OUT_GridOpt/", TString Sig_name = "../delphes_B3_1M_PU0_Btag.root", TString Bac_name = "../delphes_ttbar_1M_PU0.root" ){
  ...
  float cut_dR_l1l2_init = 1.4, cut_dR_l1l2_end = 2.2, cut_dR_l1l2_step = 0.2;
  ...
  float cut_dR_b1b2_init = 2.4, cut_dR_b1b2_end = 3.8, cut_dR_b1b2_step = 0.2;
  ...
  float cut_dR_b1b2_min_init = 0.6, cut_dR_b1b2_min_end = 1.6, cut_dR_b1b2_min_step = 0.2;
  ...
  float cut_mass_l1l2_init = 55., cut_mass_l1l2_end = 80., cut_mass_l1l2_step = 5.;
  ...
  float cut_mass_b1b2_init = 140., cut_mass_b1b2_end = 180., cut_mass_b1b2_step = 5.;
  ...
  float cut_mass_b1b2_min_init = 60., cut_mass_b1b2_min_end = 100., cut_mass_b1b2_min_step = 5.;
  ...
  float cut_dR_bl_init = 1.25, cut_dR_bl_end = 2.5, cut_dR_bl_step = 0.25;
  ...
  for( i1=0; i1<cut_dR_l1l2.size(); i1++ ){
	...
	for( i2b=0; i2<cut_dR_b1b2_min.size(); i2b++ ){
	  for( i3=0; i3<cut_mass_l1l2.size(); i3++ ){
		...
		for( i5=0; i5<cut_mass_b1b2_min.size(); i5++ ){
		  for( i6=0; i6<cut_dR_bl.size(); i6++ ){
		    ...
		    cout<<selection<<endl;
		    if(nBin%1000==0) cout<<"Bin: "<<nBin<<endl;
