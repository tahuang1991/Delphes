...
{
  const char *appName = "ttbarValidation";
  ...
  //ttbarWWbb *diHiggsValidate = new ttbarValition();
  ttbartoWWbb *ttValidate = new ttbartoWWbb(inputFile, outputFile, nEvent);

//------------------------------------------------------------------------------
// Here you call your macro's main function 
  ttValidate->ttbartoWWbbrun();
  ttValidate->writeTree();
//------------------------------------------------------------------------------
