...
CrossSections_and_BR::CrossSections_and_BR(){
  ...
  Xsec_tt  = 953;
  //Optimistic
  Xsec_B1  = 1.1948649279633416 * 1.1948649279633416;
  Xsec_B2  = 0.5900264559172156 * 0.7401476862292035;
  Xsec_B3  = 0.4431392872406074 * 0.4431392872406074;
  Xsec_B4  = 0.3629024495635394 * 0.3629024495635394;
  Xsec_B5  = 0.3629024495635394 * 0.30714428242103997;
  ...
  Xsec_B6p  = 0.6287516002157237 * 0.6203415872908459;
  ...
  Xsec_B10p = 0.022251282360094736 * 0.022251282360094736;
  Xsec_B11p = 0.008634923814275509 * 0.1209097235855364;
  Xsec_B12p = 0.006798741039330509 * 0.006798741039330509;
  //BR
  BR_h_bb   = 0.577;
  BR_h_WW   = 0.215;
  BR_W_lnu  = 0.3257;
