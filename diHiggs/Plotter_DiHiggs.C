...
void Plotter_DiHiggs( TString folder="Plots_FileOptim_B6", TString File_S="Output/delphes_B3_1M_PU0_Btag_Sim_noMMCnoMVA.root", TString File_B="Output/delphes_tt_1M_PU0_Wtobmu_Sim_noMMCnoMVA.root"){
  gROOT->Reset(); 
  // Topology
  int Topology =- 1;
